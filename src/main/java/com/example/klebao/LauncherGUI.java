...
public class LauncherGUI extends JFrame {
    ...
    public LauncherGUI() {
        ...
        JLabel instructionsLabel = new JLabel("<html>" + "<div style='text-align:center; font-weight:bold; font-size:13px; margin-bottom:0; padding-bottom:0;'>Instruções:</div>" + "<div style='margin-top:4px;'>" + "- Clique em 'Escolher Arquivo' para selecionar um " + "arquivo de código-fonte com extensão .261<br>" + "- Após selecionar, clique em 'Executar Análise' para iniciar o processamento.<br>" + "- Os arquivos de saída (.LEX e .TAB) serão gerados na pasta /output do projeto." + "</div>" + "</html>");
